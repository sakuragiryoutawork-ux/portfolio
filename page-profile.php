    ...
    <section class="About">
        ...
        <div class="ziko">
            ...
            <div class="text">
                ...
                <p class="ziko_ab">1999年徳島生まれ。<br>
                    高校卒業後、専門学校で電気工事とCADを学び、制御盤の設計業務に従事しておりました。<br>
                    実務を通して、入力と出力の関係や条件によって動作を制御する仕組みに面白さを感じ、
                    論理的に物事を組み立てる力を培いました。<br>
                    その経験から、より柔軟に仕組みを設計できるプログラミング分野に興味を持ち、
                    現在はプログラミングスクールでWeb開発を中心に学習中です。<br>
                    これまでの制御設計の経験を活かし、
                    設計から実装までを意識できるエンジニアを目指しています。</p>
            </div>
        </div>
    </section>
